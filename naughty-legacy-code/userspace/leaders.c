...
/*         SEQ_TWO_KEYS(KC_W, KC_O) {  // move window right, scale
 * appropreiately */
/*             SEND_STRING(SS_LSFT(SS_LALT("l"))); */
/*         } */
/*         // Bspwm - linux window manager commands (consider actually just
 * making these the same as display fusion, or the opposit.) */

/*         // synergy commands */
/*         // .. Lead, a(pplications), s(ynergy), s(wap) - swap cursor/focus to
 * other computer. */
