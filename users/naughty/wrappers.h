...
#define _________________NORMIES_L1_________________        KC_Q,    KC_W,    KC_E,    KC_R,    KC_T
#define _________________NORMIES_L2_________________        KC_A,    KC_S,    KC_D,    KC_F,    KC_G
#define _________________NORMIES_L3_________________        KC_Z,    KC_X,    KC_C,    KC_V,    KC_B

#define _________________NORMIES_R1_________________        KC_Y,    KC_U,    KC_I,    KC_O,    KC_P
#define _________________NORMIES_R2_________________        KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN
#define _________________NORMIES_R3_________________        KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLASH

#define _________________PlanckMQWERTY_L1___________        KC_Q,    NV_W,    NUM_E,    VI_R,    KC_T // special for planck because i need to be able to raise with some key on the left side of the board.
...
#define _________________RAISE_R3__________________        KC_F12,       KC_1,    KC_2,    KC_3, KC_UNDS



#define _________________ADJUST_L1_________________        TO(_BASE), TO(_GAMING), TO(_ROGUE), TO(_NORMIES), _______
...
#define _________________GAMING3_L2__________________       AL_A,    CT_S,    SH_D,    GU_F,    KC_G
...
#define _________________GAMING3_R2__________________       KC_H,    GU_J,    SH_K,    CT_L,    AL_SCN
#define _________________GAMING3_R3__________________       KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLASH
