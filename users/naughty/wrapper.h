...
#define _________________ADJUST_L1_________________        RESET,   TO(_BASE), TO(_GAMING), TO(_ROGUE)
...
#define _________________NUMPAD_R1__________________       KC_KP_7, KC_KP_8, KC_KP_9, _______, KC_NLCK,
